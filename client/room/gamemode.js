...
// создаем модульные функционированные команды 
 ...
 const blueTeam = CreateNewTeam('Blue', '<b><size=85><color=#0d177c>ß</color><color=#03088c>l</color><color=#0607b0>ᴜ</color><color=#1621ae>E</color></size></b>', new Colot(0, 0, 125/255, 0), 1, BuildBlocksSet.Blue);
